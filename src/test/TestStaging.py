...
class TestStaging(unittest.TestCase):
    ...
    def test_check_if_table_exists(self):
        """
        Tests check_if_table_exists function in Staging.py to validate the result returned.
        """
        table_nm = "links"
    ...
    def test_stage_ratings_files1(self):
        """
        Tests schema generated by stage_ratings_files function in Staging.py
        """
    ...
    def test_stage_ratings_files2(self):
        """
        Tests data staged stage_ratings_files function in Staging.py
        """
        ratings_table_name = "ratings"
        ratings_update_table_name = "ratings_update"
        df1 = self.spark.createDataFrame(
    ...
    def test_stage_movies_files1(self):
        """
        Tests schema generated by stage_movies_files function in Staging.py
        """
    ...
    def test_stage_movies_files2(self):
        """
        Tests data staged by stage_movies_files function in Staging.py
        """
        movies_table_name = "movies"
        df1 = self.spark.createDataFrame(
            (["1", "alpha", "crime|thriller"], ["2", "beta", "crime"], ["2", "delta", "thriller"]),
    ...
    def test_stage_tags_files1(self):
        """
        Tests schema generated by stage_tags_files function in Staging.py
        """
    ...
    def test_stage_tags_files2(self):
        """
        Tests data staged by stage_tags_files function in Staging.py
        """
        tags_table_name = "tags"
        ratings_update_table_name = "ratings_update"
        df1 = self.spark.createDataFrame(
